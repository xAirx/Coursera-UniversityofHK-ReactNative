  ...
  render() {
    ...
    return (
      <Animatable.View animation="fadeInDown" duration={500} delay={1000}>
        <Tile title="Login Area" featured imageSrc={{ url: 'http://localhost:3000/images/login.png' }}></Tile>
        <Card>
          <Input
...
class RegisterTab extends Component {
  ...
  render() {
    return (
      <ScrollView>
        <Animatable.View animation="fadeInDown" duration={500} delay={1000}>
          <Tile title="Registration Area" featured imageSrc={{ url: 'http://localhost:3000/images/login.png' }}></Tile>
          <View style={styles.container}>
            <Card>
              <Image
                ...
                style={styles.image}
              />
              <Button title="Add Profile Picture" onPress={this.getImageFromCamera} />
              <Button title="Select from Gallery" onPress={this.getImagefromGallery} />
              <Input
                placeholder="Username"
                onChangeText={username => this.setState({ username })}
