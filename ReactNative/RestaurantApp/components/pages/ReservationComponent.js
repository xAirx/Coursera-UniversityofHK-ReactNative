...
import { Text, View, ScrollView, StyleSheet, Picker, Switch, Button, Modal, Alert, SafeAreaView } from 'react-native';
    ...
    return (
      <ScrollView>
        ...
        <Animatable.View animation="fadeInDown" duration={500} delay={1000}>
          <Tile title="Reserve Table" featured imageSrc={{ url: 'http://localhost:3000/images/reserved.png' }}></Tile>
          <Card>
